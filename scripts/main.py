...
def save_to_bedgraph(batch_range, item, task, channel, intervals,
                     outfile, rounding=None, threshold=None, bin_size=None):
    ...
    Args:
        ...
        bin_size : resolution of output files
    ...
    if (scores > 0).any():
        ...
        # intervals
        batch_bg = intervals_to_bg(batch_intervals, bin_size)
...
def writer(infer, intervals_file, exp_dir, result_fname,
           ...
           res_queue, prefix, deletebg, bin_size):
