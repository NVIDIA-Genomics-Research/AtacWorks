...
r"""Read data from bigWig files and generate batch data for training."""
...
def bw2h5(noisybw, cleanbw, layersbw, cleanpeakbw, batch_size, nolabel,
    ...
    Args:
        ...
        nolabel: No peak labels to encode into h5. Used for generating
        data to
        run inference on.
