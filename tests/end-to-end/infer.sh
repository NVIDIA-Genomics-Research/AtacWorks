...
python $utils_dir/verify_diff.py --result_path $out_dir/inference_latest/bw2h5/HSC.5M.chr123.10mb.coverage.bw.wg.h5 \
...
echo ""
echo "Verifying generated h5 files."
python $utils_dir/verify_diff.py --result_path $out_dir/logistic_inference_latest/bw2h5/HSC.5M.chr123.10mb.coverage.bw.wg.h5 \
